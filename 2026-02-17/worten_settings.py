...
def get_manual_config():
    """Return the user-provided manual bypass config."""
    return "chrome120", MANUAL_HEADERS, MANUAL_COOKIES
...
def get_session_config(is_homepage=False):
    """Return a synchronized pair of impersonate and headers with advanced bypass signals."""
